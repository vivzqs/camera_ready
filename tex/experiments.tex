...
(See~\Tref{table:quantitative}). Note that even without the object point
clouds, our method achieves high precision thanks to our compact but
accurate detail reconstruction algorithm.
