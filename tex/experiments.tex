...
three datasets (S4)-(S5) have the same rooms but contain objects and
wall details.
...
(See~\Tref{table:quantitative}). We observe that even without the object
point clouds, our method achieves high precision despite the low-polygon
counts.
%, thanks to our room and detail reconstruction algorithms.
%compact but accurate reconstruction of details on walls, floor and
%ceiling.
...
\begin{figure*}[!t]
\begin{center}
\includegraphics[width=162mm]{../figures/result_real2.pdf}
\end{center}
 \vspace{-0.3cm}
...
\caption{Statistics of the real experiments. Here we show the number of
 ...
 \vspace{-0.5cm}
\begin{center}
\includegraphics[width=85mm]{../figures/statistics2.pdf}
\end{center}
...
node. The third row shows the full renderings including the object point
clouds, which are rendered by the point-based rendering technique. Our
models are segmented and annotated with the structural element types
...
%
These clean models enable high quality texture mapping and rendering
experiences as well as interesting post geometry processing, as
demonstrated in our supplementary video.
\begin{figure}[!t]
\begin{center}
\includegraphics[width=85mm]{../figures/comp_samemesh2.pdf}
\end{center}
 \vspace{-0.3cm}
...
preserves the number of structural cluster (\eg, rooms and aisles) and
important details.
