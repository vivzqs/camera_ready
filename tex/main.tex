...
%annotated 3D model.
The paper also proposes a new room segmentation algorithm and an offset-map
...
The source code and the data are available at the project website~\cite{SIMProject}.
