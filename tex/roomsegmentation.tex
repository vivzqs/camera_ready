...
creating and removing rooms. However, we empirically found that the room segmentation process converges after the first room merging as shown in~\Fref{fig:graph}.
